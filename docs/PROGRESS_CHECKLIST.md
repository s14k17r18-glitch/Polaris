...
## M0（基盤・パリティ前提）
- [ ] M0-A1 iOS Shell の有無確認（apps/dangi_app/ios/） / DoD: 有無が事実で書ける
- [ ] M0-A2 iOS Shell 追加（生成のみ） / DoD: apps/dangi_app/ios/ が作成され差分確認済み
- [ ] M0-A3 verify（WSL）完走 / DoD: melos run verify がpass
